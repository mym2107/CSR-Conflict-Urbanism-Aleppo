...
* HistoricalMapA.zip, Download [here](link to repository)
* Aleppo.zip, Download [here](link to repsotitory)
* Layers.html, Download [here](link to repository)
...
Next, add the Alp1.shp file from *Aleppo.zip*, through `Menu > Layer > Add Layer > Add Raster layer`. Likewise, you can always *drop* the file directly into the `map window`. 
